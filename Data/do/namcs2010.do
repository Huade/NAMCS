infix using namdict2010.dct,   using (NAMCS2010) clear
...
label variable INJURY "Is visit injury related? (recoded)"
...
label variable CASTAGE "What is the stage of the patient's cancer?"
...
label variable REFOTHMD "Refer to other physician"
...
label variable NHVISR "During last normal week of practice, nursing home visits?"
label variable HOMVISR "During last normal week of practice, other home visits?"
label variable HOSVISR "During last normal week of practice, hospital visits?"
label variable TELCONR "During last normal week of practice, telephone consults w/pats?"
...
label variable EMEDREC "Does practice use EMR or EHR system (not including billing records systems)?"
label variable EDEMOG "Does practice have computerized system for pat history & demographic info?"
label variable EPROLST "If yes, does this include a patient problem list?"
label variable EPNOTES "Does practice have computerized system for clinical notes?"
label variable EMEDS "If yes, do they include list of medications patient is currently taking?"
label variable EALLERG "If yes, do they include a comprehensive list of pt allergies (inc med allergies)?"
label variable ECPOE "Does practice have computerized system for orders for prescriptions?"
label variable EWARN "If yes, are warnings of drug interactions/contradindications provided?"
label variable ESCRIP "If yes, are prescriptions sent electronically to the pharmacy?"
label variable ECTOE "Does practice have computerized system for orders for tests?"
label variable EORDER "If yes, are orders sent electronically?"
label variable ERESULT "Does practice have computerized system for viewing lab results?"
label variable ERESEHR "If yes, are results incorporated in EMR/EHR?"
label variable ERANGE "If yes, are out of range levels highlighted?"
label variable EIMGRES "Does practice have computerized system for viewing imaging results?"
label variable EREMIND "Does practice have computerized system for reminders for interventions/tests?"
label variable EIMMREG "Does practice have computerized system for elec report to immunization registries?"
label variable EHRWHO1 "Orders for Rx or lab tests sent by prescribing practitioner - unedited"
label variable EHRWHO2 "Orders for Rx or lab tests sent by other clinician (including RN) - unedited"
label variable EHRWHO3 "Orders for Rx or lab tests sent by lab technician - unedited"
label variable EHRWHO4 "Orders for Rx or lab tests sent by administrative personnel - unedited"
label variable EHRWHO5 "Orders for Rx or lab tests sent by other - unedited"
label variable EHRWHO6 "Orders for Rx or lab tests not sent electronically - unedited"
label variable EHRWHO7 "Orders for Rx or lab tests sent by unknown - unedited"
label variable EHRWHO1R "Orders for Rx or lab tests sent by prescribing practitioner - edited"
label variable EHRWHO2R "Orders for Rx or lab tests sent by other clinician (including RN) - edited"
label variable EHRWHO3R "Orders for Rx or lab tests sent by lab technician - edited"
label variable EHRWHO4R "Orders for Rx or lab tests sent by administrative personnel - edited"
label variable EHRWHO5R "Orders for Rx or lab tests sent by other - edited"
label variable EHRWHO6R "Orders for Rx or lab tests not sent electronically - edited"
label variable EHRWHO7R "Orders for Rx or lab tests sent by unknown - edited"
label variable PAYHIT "Does your practice have plans to apply for Medicare or Medicaid incentive payments?"
label variable PAYYR "What year does your practice expect to apply for the meaningful use payments"
label variable PAYINC "What incentive payment does your practice plan to apply for?"
label variable EMRINS "At your practice, plans for installing new EMR/EHR system in next 18 months?"
...
label variable ETHIM "Ethnicity (with missing values imputed)"
...
label variable CHOL "Was total cholesterol drawn within 12 months?"
label variable CHOLRES "Most recent result for total cholesterol"
label variable DAYDCHOL "Difference in days between visit and most recent cholesterol draw"
label variable HDL "Was high density lipoprotein (HDL) drawn within 12 months?"
label variable HDLRES "Most recent result for high density lipoprotein (HDL)"
label variable DAYDHDL "Difference in days between visit and most recent HDL draw"
label variable LDL "Was low density lipoprotein (LDL) drawn within 12 months?"
label variable LDLRES "Most recent result for low density lipoprotein (LDL)"
label variable DAYDLDL "Difference in days between visit and most recent LDL draw"
label variable TGS "Were triglycerides drawn within 12 months?"
label variable TGSRES "Most recent result for triglycerides"
label variable DAYDTGS "Difference in days between visit and most recent triglyceride draw"
label variable A1C "Was glycohemoglobin (HgbA1C) drawn within 12 months"
label variable A1CRES "Most recent result for glycohemoglobin (HgbA1C)"
label variable DAYDA1C "Difference in days between visit and most recent HgbA1C draw"
label variable FBG "Was fasting blood glucose (FBG) drawn within 12 months?"
label variable FBGRES "Most recent result for fasting blood glucose"
label variable DAYDFBG "Difference in days between visit and most recent FBG draw"
label variable INJR1 "Is this visit related to an injury or poisoning? (Recoded version #1)"
label variable INJR2 "Is this visit related to an injury or poisoning? (Recoded version #2)"
label variable INJDETR1 "Is this visit related to any of the following? (Recoded version #1)"
label variable INJDETR2 "Is this visit related to any of the following? (Recoded version #2)"
...
label define CASTAGEF 1 "Stage I" , add
label define CASTAGEF 2 "Stage II" , add
label define CASTAGEF 3 "Stage III" , add
label define CASTAGEF 4 "Stage IV" , add
label define CASTAGEF 6 "More than one stage is marked" , add
label define CASTAGEF -7 "Not applicable" , add
label define CASTAGEF -8 "Unknown stage" , add
label define CASTAGEF -9 "No box is marked" , add
...
label define CHOLF 1 "Yes"  
label define CHOLF 2 "No" , add
label define CHOLF -7 "N/A, provider not asked" , add
label define CHOLF -9 "Blank" , add
...
label define DAYDIFF -700 "N/A, provider not asked"  
label define DAYDIFF -800 "Unknown" , add
label define DAYDIFF -900 "Blank" , add
...
label define EDEMOGF 4 "Yes, but turned off/not used" , add
label define EDEMOGF -7 "Not applicable" , add
label define EDEMOGF -8 "Unknown" , add
label define EDEMOGF -9 "Blank" , add
label define EHRWHOF 0 "Box is not marked"  
label define EHRWHOF 1 "Box is marked" , add
label define EHRWHORF 0 "Box is not marked"  
label define EHRWHORF 1 "Box is marked" , add
label define EHRWHORF -7 "N/A based on ECTOE/ECPOE" , add
...
label define EMRINSF 1 "Yes"  
label define EMRINSF 2 "No" , add
label define EMRINSF 3 "Maybe" , add
label define EMRINSF -8 "Unknown" , add
label define EMRINSF -9 "Blank" , add
...
label define MEDCODF 00419 "ACETIC ACID/ANTIPYRINE/BENZOCAINE/POLYC" , add
...
label define MEDCODF 10198 "BSS PLUS WITH EPI VANCOMYCIN AND GENTAM" , add
...
label define PAYHITF 	1 "Yes"  
label define PAYHITF 2 "Uncertain" , add
label define PAYHITF 3 "No" , add
label define PAYHITF -9 "Blank" , add
label define PAYINCF 1 "Medicare"  
label define PAYINCF 2 "Medicaid" , add
label define PAYINCF -7 "Not applicable" , add
label define PAYINCF -8 "Unknown" , add
label define PAYINCF -9 "Blank" , add
...
label define PAYYRF 1 "2011"  
label define PAYYRF 2 "2012" , add
label define PAYYRF 3 "After 2012" , add
label define PAYYRF -7 "Not applicable" , add
label define PAYYRF -8 "Unknown" , add
label define PAYYRF -9 "Blank" , add
...
label define RESULTF -7 "N/A, provider not asked"  
label define RESULTF -9 "Blank" , add
label define RETYPOF 1 "Private solo or group practice"  
label define RETYPOF 2 "Freestanding clinic/urgicenter" , add
label define RETYPOF 3 "Federally qualified health center (FQHC)" , add
...
label define SERVICEF 0 "No services were reported"  
label define SERVICEF 1 "At least one service was reported" , add
...
label values INJDET INJDETR1 INJDETR2 INJDETF
label values INJURY INJURYF
label values INJR1 INJR2 INJURYF
...
label values EMEDS EDEMOGF
label values EALLERG EDEMOGF
...
label values ERESEHR EDEMOGF
label values ERANGE EDEMOGF
label values EIMGRES EDEMOGF
label values EREMIND EDEMOGF
label values EIMMREG EDEMOGF
label values EHRWHO1 EHRWHOF
label values EHRWHO2 EHRWHOF
label values EHRWHO3 EHRWHOF
label values EHRWHO4 EHRWHOF
label values EHRWHO5 EHRWHOF
label values EHRWHO6 EHRWHOF
label values EHRWHO7 EHRWHOF
label values EHRWHO1R EHRWHORF
label values EHRWHO2R EHRWHORF
label values EHRWHO3R EHRWHORF
label values EHRWHO4R EHRWHORF
label values EHRWHO5R EHRWHORF
label values EHRWHO6R EHRWHORF
label values EHRWHO7R EHRWHORF
label values PAYHIT PAYHITF
label values PAYYR PAYYRF
label values PAYINC PAYINCF
label values EMRINS EMRINSF
...
label values CHOL CHOLF
label values HDL CHOLF
label values LDL CHOLF
label values TGS CHOLF
label values A1C CHOLF
label values FBG CHOLF
label values CHOLRES RESULTF
label values HDLRES RESULTF
label values LDLRES RESULTF
label values TGSRES RESULTF
label values A1CRES RESULTF
label values FBGRES RESULTF
label values DAYDCHOL DAYDIFF
label values DAYDHDL DAYDIFF
label values DAYDLDL DAYDIFF
label values DAYDTGS DAYDIFF
label values DAYDA1C DAYDIFF
label values DAYDFBG DAYDIFF

save NAMCS2010, replace
