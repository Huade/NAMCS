  ...
  There are two ways to read the 2006 NAMCS and NHAMCS public-use data files into Stata:

  Option 1 - Use the self-extracting file in the Stata folder to open a complete
  Stata dataset of the 2006 NAMCS, NHAMCS-ED, or NHAMCS-OPD public-use files. 
  In addition to the README06.TXT file, the Stata folder contains a Stata dataset 
