...
\section{Diagnostics of propensity score estimation and balance}
...
In our analysis, each treatment variable of interest has three ASMD statistics, including the difference between non-adopter and fully adaptor, the difference between non-adopter and partially adopted and the difference between partially adopted and fully adopted. We collapse these three statistics to covariate level for comparison propose. Table \ref{tab:psbalance} shows that few variables' ASMDs exceeds 0.10 threshold after weighting but non of them exceed 0.1260. 
